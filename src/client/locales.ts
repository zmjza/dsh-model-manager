...
export const en = {
  ...
  sharedHint: 'Shares the same configuration as the official Models page.',
  instances: 'instances: {count}',
  familyCloneHint: 'New instance in the {family} family — enter a distinct relay endpoint below.',
  ...
  defaultThinkingLevelNone: 'Provider default',
  effortDetect: 'Detect',
  effortDetecting: 'Detecting…',
  effortDetectNone: 'This model advertises no selectable thinking levels.',
  hideModel: 'Show in picker',
  hidden: 'Hidden',
  shown: 'Shown',
  effortSliderAria: 'Thinking level slider',
  effortSliderTitle: 'Thinking level',
  effortSliderProviderDefault: 'Provider default',
  effortSliderNav: 'Effort',
  effortSliderLow: 'Low',
  effortSliderHigh: 'High',
  effortSliderMaxYield: 'MAXIMUM YIELD',
  ...
  testLink: 'Test connectivity',
  testRunning: 'Testing\u2026',
  testFailed: 'Test failed',
  testModalTitle: 'Test account connection',
  testModalStream: 'STREAM',
  testModelPick: 'Pick a test model',
  testStart: 'Start test',
  testRetry: 'Retry',
  testConsoleEmpty: 'Pick a model and click Start test.',
  testLogStart: 'Start testing account: {name}',
  testLogType: 'Account type: {type}',
  testLogConnected: 'Connected to API',
  testLogModel: 'Using model: {model}',
  testLogSend: 'Sending test message: "hi"',
  testLogReply: 'Response: {reply}',
  testDone: '\u2713 Test complete!',
  testLogBad: '\u2717 Test failed: {reason}',
  testOk: 'Connected · {model} ~{ms}ms',
  testAuth: 'API key invalid or unauthorized',
  testNetwork: 'Could not connect',
  testTimeout: 'Connection timed out',
  testMissing: 'Missing information',
  testInvalid: 'Bad endpoint',
  testModel: 'Model not found or unusable',
  testDetail: '({detail})',
  retrySettings: 'Retry per model',
  retryHeading: 'Per-model retry count',
  retryHint: 'Retry runs per provider. Each model owns a count (default 5); a provider retries as many times as the highest count among its models, so every model gets at least the retries it asks for.',
  modelRetry: 'Retry count',
  retryReset: 'Reset to 5',
  retrySave: 'Save',
  retrySaved: 'Saved',
...
export const zh: { [Key in keyof typeof en]: string } = {
  nav: '模型增强',
  title: '模型增强',
  sharedHint: '与官方「模型」页共享同一份配置。',
  instances: '实例：{count}',
  familyCloneHint: '正在基于「{family}」创建新实例——请填写不同的中转地址。',
  ...
  thinkingLevels: '思考程度',
  defaultThinkingLevel: '默认思考程度',
  defaultThinkingLevelNone: '提供方默认',
  effortDetect: '检测',
  effortDetecting: '检测中…',
  effortDetectNone: '该模型未公布可选择的思考程度。',
  hideModel: '在列表显示',
  hidden: '已隐藏',
  shown: '显示中',
  effortSliderAria: '思考程度滑杆',
  effortSliderTitle: '思考程度',
  effortSliderProviderDefault: '提供方默认',
  effortSliderNav: '思考程度',
  effortSliderLow: '低',
  effortSliderHigh: '高',
  effortSliderMaxYield: 'MAXIMUM YIELD',
  fetchModels: '获取可用模型',
  ...
  testRunning: '测试中…',
  testFailed: '测试失败',
  testOk: '连接正常 · {model} 约 {ms}ms',
  testAuth: 'API 密钥无效或无权限',
  testNetwork: '无法连接',
  testTimeout: '连接超时',
  testMissing: '信息缺失',
  testInvalid: '接口地址有误',
  testModel: '模型不存在或不可用',
  testDetail: '（{detail}）',
  testModalTitle: '测试账号连接',
  testModalStream: '流式',
  testModelPick: '选择测试模型',
  testStart: '开始测试',
  testRetry: '重试',
  testConsoleEmpty: '请选择模型后点击「开始测试」。',
  testLogStart: '开始测试账号: {name}',
  testLogType: '账号类型: {type}',
  testLogConnected: '已连接到 API',
  testLogModel: '使用模型: {model}',
  testLogSend: '发送测试消息: "hi"',
  testLogReply: '响应: {reply}',
  testDone: '✓ 测试完成!',
  testLogBad: '✗ 测试失败: {reason}',
  retrySettings: '各模型重试',
  retryHeading: '各模型重试请求次数',
  retryHint: '重试按提供方整体执行。每个模型都有一个次数（默认5），提供方实际按全部模型中最大次数重试，保证每个模型至少得到它自己配置的重试次数。',
  modelRetry: '重试请求次数',
  retryReset: '重置为 5',
  retrySave: '保存',
  retrySaved: '已保存',
